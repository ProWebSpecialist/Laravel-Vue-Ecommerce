        ...
        <table id="delivery-table" class="table table-striped">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($delivery->id); ?>">
                    ...
                    <td>Chevrolet cheyenne BEP429-2</td>
                    <?php elseif($delivery->truck_id == '15'): ?>
                    <td>Chevrolet cheyenne SRD520-2</td>
